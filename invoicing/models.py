...
class Invoice(models.Model):
    ...
    sequence = models.IntegerField(_(u'sequence'), db_index=True, blank=True, default=None)
    ...
    subtitle = models.CharField(_(u'subtitle'), max_length=255, blank=True, default=None)
    ...
    constant_symbol = models.CharField(_(u'constant symbol'), max_length=64, choices=CONSTANT_SYMBOL, blank=True, default=None)
    ...
    specific_symbol = models.PositiveIntegerField(_(u'specific symbol'),
        validators=[MinValueValidator(0), MaxValueValidator(9999999999)],
        blank=True, null=True, default=None)
    reference = models.CharField(_(u'reference'), max_length=140, blank=True, default=None)

    bank_name = models.CharField(_(u'bank name'), max_length=255, blank=True, default=None)
    bank_street = models.CharField(_(u'bank street and number'), max_length=255, blank=True, default=None)
    bank_zip = models.CharField(_(u'bank ZIP'), max_length=255, blank=True, default=None)
    bank_city = models.CharField(_(u'bank city'), max_length=255, blank=True, default=None)
    bank_country = CountryField(_(u'bank country'), max_length=255, blank=True, default=None)
    ...
    supplier_street = models.CharField(_(u'supplier street and number'), max_length=255, blank=True, default=None)
    supplier_zip = models.CharField(_(u'supplier ZIP'), max_length=255, blank=True, default=None)
    supplier_city = models.CharField(_(u'supplier city'), max_length=255, blank=True, default=None)
    supplier_country = CountryField(_(u'supplier country'), default=None)
    supplier_registration_id = models.CharField(_(u'supplier Reg. No.'), max_length=255, blank=True, default=None)
    supplier_tax_id = models.CharField(_(u'supplier Tax No.'), max_length=255, blank=True, default=None)
    supplier_vat_id = VATField(_(u'supplier VAT No.'), blank=True, default=None)
    ...
    # Contact details
    issuer_name = models.CharField(_(u'issuer name'), max_length=255, blank=True, default=None)
    issuer_email = models.EmailField(_(u'issuer email'), blank=True, default=None)
    issuer_phone = models.CharField(_(u'issuer phone'), max_length=255, blank=True, default=None)

    # Customer details
    customer_name = models.CharField(_(u'customer name'), max_length=255, default=None)
    customer_street = models.CharField(_(u'customer street and number'), max_length=255, blank=True, default=None)
    customer_zip = models.CharField(_(u'customer ZIP'), max_length=255, blank=True, default=None)
    customer_city = models.CharField(_(u'customer city'), max_length=255, blank=True, default=None)
    customer_country = CountryField(_(u'customer country'), default=None)
    customer_registration_id = models.CharField(_(u'customer Reg. No.'), max_length=255, blank=True, default=None)
    customer_tax_id = models.CharField(_(u'customer Tax No.'), max_length=255, blank=True, default=None)
    customer_vat_id = VATField(_(u'customer VAT No.'), blank=True, default=None)
    customer_additional_info = JSONField(_(u'customer additional information'),
        load_kwargs={'object_pairs_hook': OrderedDict},
        blank=True, null=True, default=None)
    customer_email = models.EmailField(_(u'customer email'), blank=True, default=None)
    customer_phone = models.CharField(_(u'customer phone'), max_length=255, blank=True, default=None)

    # # Shipping details
    # shipping_name = models.CharField(_(u'shipping name'), max_length=255, blank=True, default=None, null=True)
    # shipping_street = models.CharField(_(u'shipping street and number'), max_length=255, blank=True, default=None, null=True)
    # shipping_zip = models.CharField(_(u'shipping ZIP'), max_length=255, blank=True, default=None, null=True)
    # shipping_city = models.CharField(_(u'shipping city'), max_length=255, blank=True, default=None, null=True)
    # shipping_country = CountryField(_(u'shipping country'), blank=True, default=None, null=True)
