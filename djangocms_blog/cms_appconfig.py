...
class BlogConfigForm(AppDataForm):
    ...
    def __init__(self, *args, **kwargs):
        super(BlogConfigForm, self).__init__(*args, **kwargs)

        self.fields['default_image_full'].queryset = ThumbnailOption.objects.all()
        self.fields['default_image_full'].initial = 3

        self.fields['default_image_thumbnail'].queryset = ThumbnailOption.objects.all()
        self.fields['default_image_thumbnail'].initial = 1
